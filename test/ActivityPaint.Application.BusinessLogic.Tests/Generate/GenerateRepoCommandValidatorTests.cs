...
public class GenerateRepoCommandValidatorTests
{
    [Fact]
    public void WhenAllCorrect_ShouldBeValid()
    {
        ...
        var validator = new GenerateRepoCommandValidator([presetMock.Object], [authorMock.Object]);
    ...
    private static GenerateRepoCommand GetValidModel() => new(

...
public class GenerateCommitsCommandValidatorTests
{
    [Fact]
    public void WhenAllCorrect_ShouldBeValid()
    {
        ...
        var validator = new GenerateCommitsCommandValidator([mock.Object]);
    ...
    private static GenerateCommitsCommand GetValidModel() => new(
